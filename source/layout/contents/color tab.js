...
var shpPalletBtn = currentGrp.add('iconbutton', undefined, palletIcon, { name: 'btn', style: 'toolbutton' });
...
var arrowOnAirBtn = colorSubGrp4.add('iconbutton', undefined, arrowOnAirIcon, { name: 'btn', style: 'toolbutton' });
arrowOnAirBtn.helpTip = 'arrow on-air';

var logoStaticBtn = colorSubGrp4.add('iconbutton', undefined, newsStaticIcon, { name: 'btn', style: 'toolbutton' });
logoStaticBtn.helpTip = 'GNEWS logo static';

var logoAnim3sBtn = colorSubGrp4.add('iconbutton', undefined, newsAnimIcon, { name: 'btn', style: 'toolbutton' });
