...
wigBtn.onClick = function () {
  ...
  for (i = 0; i < selLayers.length; i++) {
    wLayer = selLayers[i];
    wProp = wLayer.property('ADBE Transform Group')
...
ikBtn.onClick = function () {
  ...
  var bone1Pos = bone1.property('ADBE Transform Group')
    .property('ADBE Position').value;
  var bone1Rot = bone1.property('ADBE Transform Group')
    .property('ADBE Rotate Z').value;
  var bone3Pos = bone3.property('ADBE Transform Group')
    .property('ADBE Position').value;
  ...
  zeroLayer.property('ADBE Transform Group')
    .property('ADBE Position').setValue(bone3Pos);
  ...
  bone1.property('ADBE Transform Group')
    .property('ADBE Rotate Z').expression = expStr1;
  bone2.property('ADBE Transform Group')
    .property('ADBE Rotate Z').expression = expStr2;
  bone3.property('ADBE Transform Group')
    .property('ADBE Position').expression = expStr3;
  bone3.property('ADBE Transform Group')
    .property('ADBE Rotate Z').expression = expStr4;

  if (bone1.property('ADBE Transform Group').property('ADBE Rotate Z').value != bone1Rot) {
    ctrlLayer.property('ADBE Effect Parade')
      .property('simple IK').property('flip orientation')
      .setValue(true);
  }
